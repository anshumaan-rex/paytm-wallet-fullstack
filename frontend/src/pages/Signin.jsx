...
const Signin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("http://localhost:4000/api/v1/auth/signin", formData, {
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative bg-gray-900/80 backdrop-blur-md rounded-2xl border border-cyan-500/30 p-8 shadow-xl">
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-cyan-200/80">Sign in to your account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-between items-center">
              <label className="flex items-center">
                <input 
                  type="checkbox" 
                  className="h-4 w-4 text-cyan-500 focus:ring-cyan-500 border-gray-600 rounded bg-gray-800/60" 
                />
          ...
          <div className="mt-6 text-center">
            <p className="text-cyan-300/80 text-sm">
              ...
              <a href="/signup" className="text-cyan-400 hover:text-cyan-300 transition-colors duration-300 font-semibold">
                Sign Up
              </a>
            </p>
          </div>
